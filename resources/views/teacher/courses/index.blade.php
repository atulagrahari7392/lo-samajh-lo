...
<div class="mb-6 flex justify-between items-center">
    ...
    <div class="flex space-x-3">
        <a href="{{ route('teacher.courses.create') }}" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors">
            + Create New Course
        </a>
    </div>
</div>
    ...
    <div class="glassmorphism rounded-2xl shadow-sm border border-gray-200 bg-white overflow-hidden flex flex-col">
        ...
        <div class="p-5 flex-1 flex flex-col">
            ...
            <div class="mt-auto border-t border-gray-100 pt-3 flex justify-between items-center">
                ...
                <a href="{{ route('teacher.courses.create') }}" class="text-blue-600 text-sm font-medium hover:underline">Edit Draft</a>
            </div>
        </div>
    </div>
</div>
