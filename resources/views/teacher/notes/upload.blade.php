...
<div class="mb-6 flex justify-between items-center">
    <div>
        <a href="{{ route('teacher.notes.index') }}" class="text-sky-500 hover:underline text-sm mb-2 inline-block">← Back to Notes</a>
        <h2 class="text-2xl font-bold text-gray-800">Upload Notes</h2>
    </div>
...
<div class="glassmorphism p-6 rounded-2xl shadow-sm border border-gray-100 bg-white max-w-2xl">
    <div class="space-y-4">
        <div>
