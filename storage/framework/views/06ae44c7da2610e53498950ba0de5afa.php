    ...
    <div class="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
      ...
      <div class="lg:col-span-7 space-y-7">
        ...
        <div class="flex flex-wrap items-center gap-4 pt-2">
          <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 rounded-2xl font-bold text-white btn-grad shadow-xl shadow-sky-500/25 text-base flex items-center gap-3">
...
<section class="py-20 bg-white dark:bg-slate-950" id="courses">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5">
      ...
      <a href="<?php echo e(route('courses.index')); ?>" class="group bg-slate-50 dark:bg-slate-900 rounded-2xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 text-center flex flex-col items-center justify-between">
        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br <?php echo e($c['color']); ?> flex items-center justify-center text-2xl text-white shadow-md group-hover:scale-110 transition-transform duration-300 mb-3">
          <?php echo e($c['icon']); ?>

        </div>
        <h3 class="font-bold text-sm text-slate-900 dark:text-white group-hover:text-sky-500 transition-colors leading-tight mb-1"><?php echo e($c['name']); ?></h3>
        <p class="text-[11px] font-semibold text-sky-600 dark:text-sky-400"><?php echo e($c['count']); ?></p>
      </a>
...
<section class="py-20 bg-slate-50 dark:bg-slate-900">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12 gap-4">
      ...
      <a href="<?php echo e(route('courses.index')); ?>" class="px-6 py-2.5 rounded-xl border border-sky-400 text-sky-600 dark:text-sky-400 hover:bg-sky-50 dark:hover:bg-slate-800 font-bold text-sm transition-colors">
        View All Courses →
      </a>
    </div>
      ...
      <div class="group bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden flex flex-col justify-between">
        <div>
          <div class="h-48 bg-gradient-to-br from-slate-800 to-slate-950 relative flex items-end p-5 overflow-hidden">
            <span class="absolute top-4 right-4 <?php echo e($course['tagBg']); ?> text-white text-[10px] font-black px-3 py-1 rounded-full uppercase shadow">
              <?php echo e($course['tag']); ?>

            </span>
            <div class="relative z-10">
              <span class="text-xs font-bold text-sky-400 uppercase tracking-wide"><?php echo e($course['category']); ?></span>
              <h3 class="text-lg font-bold text-white leading-snug line-clamp-2 mt-0.5"><?php echo e($course['title']); ?></h3>
            </div>
          </div>
          <div class="p-6 space-y-4">
            <div class="flex items-center justify-between text-xs">
              <div class="flex items-center gap-2">
                ...
                <span class="font-medium text-slate-700 dark:text-slate-300"><?php echo e($course['teacher']); ?></span>
              </div>
              <div class="flex items-center gap-1 font-bold text-amber-400">
                <span>★</span> <span><?php echo e($course['rating']); ?></span>
                <span class="text-slate-400 font-normal">(<?php echo e($course['reviews']); ?>)</span>
              </div>
            </div>
            <div class="flex items-center gap-4 text-xs text-slate-500 dark:text-slate-400">
              <span>📹 <?php echo e($course['videos']); ?> Videos</span>
              <span>📝 <?php echo e($course['tests']); ?> Tests</span>
              <span>📄 Notes</span>
            </div>
          </div>
        </div>
        <div class="p-6 pt-0 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between mt-4">
          <div>
            ...
            <?php else: ?>
              <span class="text-2xl font-black text-slate-900 dark:text-white"><?php echo e($course['price']); ?></span>
              <span class="text-xs text-slate-400 line-through ml-1.5"><?php echo e($course['origPrice']); ?></span>
            <?php endif; ?>
          </div>
          <a href="<?php echo e(route('courses.index')); ?>" class="px-5 py-2.5 rounded-xl btn-grad text-white font-bold text-xs shadow-md shadow-sky-500/20">
            Enroll Now →
          </a>
        </div>
      </div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <div class="bg-slate-50 dark:bg-slate-900 rounded-3xl p-6 border border-red-200 dark:border-red-900/50 shadow-sm relative overflow-hidden space-y-4">
        ...
        <a href="<?php echo e(route('login')); ?>" class="block w-full text-center py-3 rounded-xl bg-red-500 text-white font-bold text-xs hover:bg-red-600 transition-colors shadow">
          Join Live Class Now 🎥
        </a>
      </div>
...
function performHeroSearch() {
  ...
  if(val) window.location.href = "<?php echo e(route('courses.index')); ?>?search=" + encodeURIComponent(val);
}
</script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\atula\.gemini\antigravity\scratch\lo-samajh-lo\resources\views/home/index.blade.php ENDPATH**/ ?>