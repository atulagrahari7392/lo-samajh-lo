...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Lo Samajh Lo — India\'s #1 Learning Platform'); ?></title>
    ...
    <header class="fixed top-0 inset-x-0 z-50 transition-all duration-300 glass-header py-3.5 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
            ...
            <nav class="hidden lg:flex items-center gap-7 text-sm font-semibold text-slate-700 dark:text-slate-200">
                <a href="<?php echo e(route('home')); ?>" class="nav-link hover:text-sky-500 transition-colors">Home</a>
                
                <!-- Courses Dropdown -->
                <div class="relative group py-2">
                    <a href="<?php echo e(route('courses.index')); ?>" class="nav-link hover:text-sky-500 transition-colors flex items-center gap-1">
                        Courses
                    ...
                    <div class="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-[550px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 rounded-2xl p-6 shadow-2xl grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <ul class="space-y-2.5 text-xs font-medium">
                                <li><a href="<?php echo e(route('courses.index')); ?>?cat=graduation" class="text-slate-600 dark:text-slate-300 hover:text-sky-500 block">🎓 BA / B.Sc / B.Com Degree</a></li>
                                <li><a href="<?php echo e(route('courses.index')); ?>?cat=pg" class="text-slate-600 dark:text-slate-300 hover:text-sky-500 block">🏛️ MA / M.Sc / M.Com Masters</a></li>
                                <li><a href="<?php echo e(route('courses.index')); ?>?cat=cuet" class="text-slate-600 dark:text-slate-300 hover:text-sky-500 block">🎯 CUET Entrance Prep</a></li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="space-y-2.5 text-xs font-medium">
                                <li><a href="<?php echo e(route('courses.index')); ?>?cat=ugc-net" class="text-slate-600 dark:text-slate-300 hover:text-sky-500 block">📚 UGC NET / JRF Paper 1 + 2</a></li>
                                <li><a href="<?php echo e(route('courses.index')); ?>?cat=ssc" class="text-slate-600 dark:text-slate-300 hover:text-sky-500 block">📊 SSC CGL / CHSL / MTS</a></li>
                                <li><a href="<?php echo e(route('courses.index')); ?>?cat=banking" class="text-slate-600 dark:text-slate-300 hover:text-sky-500 block">🏦 Banking IBPS PO & SBI</a></li>
                            </ul>
                        </div>
                    </div>
                </div>

                <a href="<?php echo e(route('tests.index')); ?>" class="nav-link hover:text-sky-500 transition-colors">Test Series</a>
                ...
                <a href="<?php echo e(route('current-affairs.index')); ?>" class="nav-link hover:text-sky-500 transition-colors">Current Affairs</a>
                <a href="<?php echo e(route('blog.index')); ?>" class="nav-link hover:text-sky-500 transition-colors">Blog</a>
            </nav>
            ...
            <div class="flex items-center gap-3">
                ...
                <!-- Language Toggle -->
                <a href="<?php echo e(route('lang.switch', app()->getLocale() === 'en' ? 'hi' : 'en')); ?>" class="px-2.5 py-1 rounded-lg bg-sky-50 dark:bg-slate-800 text-sky-600 dark:text-sky-400 font-bold text-xs hover:bg-sky-100 transition-colors">
                    <?php echo e(app()->getLocale() === 'en' ? 'हिन्दी' : 'EN'); ?>

                </a>

                <!-- Login Button -->
                <a href="<?php echo e(route('login')); ?>" class="px-5 py-2.5 rounded-2xl font-bold text-xs text-sky-600 dark:text-sky-400 border border-sky-300 dark:border-sky-700 hover:bg-sky-50 dark:hover:bg-slate-800 transition-all">
                    Login / लॉगिन
                </a>

                <!-- Start Free Button -->
                <a href="<?php echo e(route('register')); ?>" class="px-5 py-2.5 rounded-2xl font-bold text-xs text-white btn-grad shadow-lg shadow-sky-500/25">
        ...
        <div id="mobileDrawer" class="hidden lg:hidden bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 mt-3 px-4 py-4 space-y-3">
            <a href="<?php echo e(route('home')); ?>" class="block py-2 text-sm font-semibold text-slate-700 dark:text-slate-200">🏠 Home</a>
            <a href="<?php echo e(route('courses.index')); ?>" class="block py-2 text-sm font-semibold text-slate-700 dark:text-slate-200">📚 Courses</a>
            <a href="<?php echo e(route('tests.index')); ?>" class="block py-2 text-sm font-semibold text-slate-700 dark:text-slate-200">📝 Test Series</a>
            <a href="<?php echo e(route('current-affairs.index')); ?>" class="block py-2 text-sm font-semibold text-slate-700 dark:text-slate-200">📄 Current Affairs</a>
            <a href="<?php echo e(route('register')); ?>" class="block w-full text-center py-3 rounded-xl font-bold text-xs text-white btn-grad">Start Free Trial</a>
        </div>
    </header>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-xs">
                        <li><a href="<?php echo e(route('tests.index')); ?>" class="hover:text-sky-400 transition-colors">Mock Test Series</a></li>
                        ...
                        <li><a href="<?php echo e(route('current-affairs.index')); ?>" class="hover:text-sky-400 transition-colors">Daily Current Affairs</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-xs">
                        <li><a href="<?php echo e(route('about')); ?>" class="hover:text-sky-400 transition-colors">About Lo Samajh Lo</a></li>
                        <li><a href="<?php echo e(route('contact')); ?>" class="hover:text-sky-400 transition-colors">Help & Contact Us</a></li>
                        <li><a href="<?php echo e(route('blog.index')); ?>" class="hover:text-sky-400 transition-colors">Latest Articles</a></li>
            ...
            <div class="border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
                <p>© <?php echo e(date('Y')); ?> Lo Samajh Lo. All rights reserved. | GST: 09AABCU9603R1ZV</p>
...
<?php /**PATH C:\Users\atula\.gemini\antigravity\scratch\lo-samajh-lo\resources\views/layouts/app.blade.php ENDPATH**/ ?>