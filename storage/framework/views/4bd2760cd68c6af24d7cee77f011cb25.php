<?php $__env->startSection('title', 'Login — Lo Samajh Lo'); ?>
        ...
        <div class="w-full md:w-1/2 bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 p-8 sm:p-12 text-white flex flex-col justify-between relative overflow-hidden border-b md:border-b-0 md:border-r border-slate-800">
            ...
            <div class="relative z-10 mt-8 space-y-3">
                ...
                <div class="flex items-center gap-3 bg-white/8 backdrop-blur rounded-xl p-3 border border-white/10">
                    <span class="text-2xl w-9 flex-shrink-0 text-center"><?php echo e($icon); ?></span>
                    <div>
                        <p class="font-bold text-sm text-white"><?php echo e($title); ?></p>
                        <p class="text-xs text-slate-400"><?php echo e($desc); ?></p>
                    </div>
                </div>
            ...
            <form action="<?php echo e(route('login')); ?>" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        autofocus
                        class="w-full px-4 py-3 rounded-xl border <?php $__errorArgs = ['login'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-slate-300 dark:border-slate-700 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-sky-400 outline-none text-sm font-medium transition-all"
                ...
                <div>
                    <div class="flex justify-between items-center mb-1.5">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-sky-500 hover:underline font-bold">Forgot?</a>
                    </div>
                    <div class="relative">
                        <input
                            type="password"
            ...
            <a href="<?php echo e(route('auth.google')); ?>" class="mt-4 flex items-center justify-center gap-3 px-4 py-2.5 border border-slate-300 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition text-slate-700 dark:text-slate-200 font-semibold text-sm">
            ...
            <p class="mt-5 text-center text-xs text-slate-500 dark:text-slate-400">
                New here? <a href="<?php echo e(route('register')); ?>" class="font-bold text-sky-600 dark:text-sky-400 hover:underline">Create free account</a>
            </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\atula\.gemini\antigravity\scratch\lo-samajh-lo\resources\views/auth/login.blade.php ENDPATH**/ ?>